...
{
    public partial class initDataMuseum : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExhibitionRoom_Museum_MuseumId",
                        column: x => x.MuseumId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfArticleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Article_ExhibitionRoom_ExhibitionRoomId",
                        column: x => x.ExhibitionRoomId,
                        principalTable: "ExhibitionRoom",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Article_TypeOfArticle_TypeOfArticleId",
                        column: x => x.TypeOfArticleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Article_ExhibitionRoomId",
                table: "Article",
                column: "ExhibitionRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_Article_TypeOfArticleId",
                table: "Article",
                column: "TypeOfArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_ExhibitionRoom_MuseumId",
                table: "ExhibitionRoom",
                column: "MuseumId");
        }
